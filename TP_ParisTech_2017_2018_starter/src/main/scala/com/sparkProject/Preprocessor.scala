...
object Preprocessor {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val df: DataFrame = spark
      ...
      .csv("/Users/baptisteaubert/Downloads/funding-successful-projects-on-kickstarter/train.csv")
...
// b) Observer les autres colonnes, comprendre les données, et proposer des cleanings
    ...
    dfFiltered.write.mode(SaveMode.Overwrite).parquet("/Users/baptisteaubert/Desktop/Big_Data_Telecom_Paris/Semestre1/HadoopSpark/Spark")
